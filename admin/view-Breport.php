...
// }
if (isset($_POST["reportBatch"])) {


  $_SESSION['batch'] = $_POST['batch'];
  
  header("Location: ../TCPDF-main/generate_bpdf.php");
}
    ...
    enable_page_level_ads: true
        ...
        <div class="row">
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select id="section" class="form-control m-bot15" name="batch" required >
                      
                      <option></option> 
                      <option value="2019-2023">2019-2023</option>
                      <option value="2020-2024">2020-2024</option>
                      <option value="2021-2025">2021-2025</option>
                      <option value="2020-2024">2022-2026</option>
                    </select>
                    </div> 
                    </div>
				    <!-- <a class="btn btn-primary" href="../TCPDF-main/generate_fpdf.php?sc" target="_blank">Download</a> -->
                    <button name="reportBatch" class="btn btn-primary">Download</button>
                </form>
              </div>
            </section>
