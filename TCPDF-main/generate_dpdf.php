...
$faculty = mysqli_query($confaculty,"SELECT * FROM faculty WHERE specialization ='".$dept."' "); 
...
EOD;
$pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);
 $feed=mysqli_query($confaculty,"SELECT * FROM feedback WHERE fnm='" .$name. "'"); 
...
$pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);
       ...
       $feed=mysqli_query($confaculty,"SELECT * FROM feedback WHERE fnm='" .$name. "' && sem=$i"); 
              $numrows1=mysqli_num_rows($feed);	
              $stotal=0;
              if($numrows1 == 0){
                continue;
