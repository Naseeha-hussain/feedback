...
// Set some content to print 
 ...
 $f=mysqli_query($confaculty,"SELECT * FROM faculty WHERE fid='" .$fcode. "' "); 
...
<h4 style="text-align:center;">FACULTY REPORT</h4>
            ...
            <p>Name of the Staff : $fname</p>
EOD;

$pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);

 $feed=mysqli_query($confaculty,"SELECT * FROM feedback WHERE fnm='" .$fname. "' "); 
...
$pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);
            ...
            for($i=1;$i<9;$i++)
         {  
       $feed=mysqli_query($confaculty,"SELECT * FROM feedback WHERE fnm='" .$fname. "' && sem=$i "); 
              $numrows1=mysqli_num_rows($feed);	
              $stotal=0;
              if($numrows1 == 0){
                continue;
